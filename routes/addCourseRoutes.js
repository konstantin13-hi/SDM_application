...
export default function(db) {
    router.post('/courses', (req, res) => {
        ...
        db.query(courseQuery, [courseName, teacher, startDate], (err, results) => {
            ...
            const studentValues = students.map(studentId => [courseId, studentId, false, new Date()]);
            const studentQuery = 'INSERT INTO attendance (course_id, student_id, present, date) VALUES ?';
